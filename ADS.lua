...
if isfile("Cosmic.txt") then
	...
	writefile("Cosmic.txt", "_G.Auto = " .."false".."\n_G.ATF = ".."true")
	_G.Auto = false
	_G.ATF = true
end
-- end
local win = Flux:Window("ADS", "By Cosmic Hub", Color3.fromRGB(255, 110, 48), Enum.KeyCode.LeftControl)
local tab1 = win:Tab("syn", "http://www.roblox.com/asset/?id=6023426915")
tab1:Toggle("Auto join", " ", _G.Auto , function(t)
    _G.Auto = t
    print(_G.ATF)
    print(_G.Auto)
writefile("Cosmic.txt", "_G.Auto = " .. tostring(_G.Auto).."\n_G.ATF = "..tostring(_G.ATF))
	--loadfile("Cosmic.txt")()
	print("Load!")

	
end)
tab1:Toggle("Auto Farm", " ", _G.ATF, function(t)
        _G.ATF = t
        writefile("Cosmic.txt", "_G.Auto = " .. tostring(_G.Auto).."\n_G.ATF = "..tostring(_G.ATF))
end)
print("Start")
...
if syn then
	game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
		if State == Enum.TeleportState.Started then
			syn.queue_on_teleport("_G.ATF = "..tostring(_G.ATF)..";loadstring(game:HttpGet('https://raw.githubusercontent.com/XCNXD/beta-script/main/ADS.lua'))()")
			print("Set!")
		end
	end)
end
if tostring(game.PlaceId) == "6938803436" and _G.Auto == true then
	...
	repeat
		...
		for i, v in pairs(game:GetService("Workspace").Folders.Monsters:GetDescendants()) do
			if v:FindFirstChild("HumanoidRootPart") and _G.ATF == true then
...
--        PQR.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0,-23.8,0)
				...
				local CFAN = v:FindFirstChild("HumanoidRootPart").CFrame * CFrame.new(0, math.random(8.3), 0)
